...
const quizData = [
    // Questão 1 — climaticoglobal.html
    {
        ...
        nextPage: "climaticoglobal2.html",
    ...
    // Questão 2 — climaticoglobal2.html
    {
        ...
        nextPage: "climaticoglobal3.html",
        backPage: "climaticoglobal.html",
    ...
    // Questão 3 — climaticoglobal3.html
    {
        ...
        backPage: "climaticoglobal2.html",
        backLabel: "Voltar ao Anterior",
        nextLabel: "Finalizar",
    },
];
...
function detectCurrentPage() {
    ...
    if (path.includes("climaticoglobal2")) return 2;
    return 1;
}
...
function renderQuiz(data) {
    ...
    if (fill) {
        ...
        requestAnimationFrame(() => {
            requestAnimationFrame(() => {
                ...
                fill.style.width = data.progressPercent + "%";
            });
        });
    }

    if (counter) {
        const pageStr  = String(data.page).padStart(2, "0");
        const totalStr = String(data.total).padStart(2, "0");
    ...
    if (qCard) {
        ...
        const p  = qCard.querySelector("p");
        if (h2) h2.textContent = data.question;
